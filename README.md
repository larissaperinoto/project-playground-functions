...
Projeto de encerramento do Bloco 4 - Introdução à JavaScript e Lógica de Programação, sendo este o segundo projeto realizado na Trybe.

## Objetivo

Resolver problemas escrevendo códigos em JavaScript que usam variáveis e tipos primitivos, utilizando o laço de repetição for, manipulando objetos e arrays, utilizando comando for/in e estruturas condicionais if/else.
...
Escreva uma função com o nome `calcArea` que receba um valor de base (chamado `base`) e outro de altura (chamado `height`) de um triângulo e retorne o cálculo da sua área. Lembre-se que a área de um triângulo é calculada através da seguinte fórmula: (base * altura) / 2.
